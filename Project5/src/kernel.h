...
struct pcb {
	...
	uint32_t fault_addr;   /* Location in sectors that generated a page fault */
	uint32_t error_code;   /* Error code associated with a page fault */
	uint32_t swap_loc;     /* Sector number where process is located on disk */
	uint32_t swap_size;    /* Size of this process in sectors on disk */
